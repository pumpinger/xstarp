...
<div class="x-panel">
    <div class="x-panel-title">场景1</div>
...
<div class="x-panel">
    <div class="x-panel-title">场景2</div>
    <div class="x-panel-content">
        <img src="./img/b1.png" />
    </div>
</div>
...
//                'overflow':'hidden',
            ...
            ctrl_recover.css({
                ...
                'margin':'10px',
                'cursor':'pointer',
                'background':'url("./dest/lib/imgView/images/square.png") no-repeat'
            });
            ...
            ctrl_magnify.css({
                ...
                'margin':'10px',
                'cursor':'pointer',
                'background':'url("./dest/lib/imgView/images/enlarge.png") no-repeat'
            });
            ...
            ctrl_shrink.css({
                ...
                'margin':'10px',
                'cursor':'pointer',
                'background':'url("./dest/lib/imgView/images/narrow.png") no-repeat'
            });
            ...
            ctrl_rotate.css({
                ...
                'margin':'10px',
                'cursor':'pointer',
                'background':'url("./dest/lib/imgView/images/Refresh_1.png") no-repeat'
            });
            ...
            ctrl_left.css({
                ...
                'top':'48%',
                'cursor':'pointer',
                'background':'url("./dest/lib/imgView/images/Left.png") no-repeat'
            });
            ...
            ctrl_right.css({
                ...
                'right':'1%',
                'top':'48%',
                'background':'url("./dest/lib/imgView/images/right.png") no-repeat'
            });
            ...
            ctrl_close.css({
                ...
                'right':'-14px',
                'top':'0',
                'background':'url("./dest/lib/imgView/images/close_1.png") no-repeat'
            });
            ...
            loading.prop('src','./dest/lib/imgView/images/load.gif');
